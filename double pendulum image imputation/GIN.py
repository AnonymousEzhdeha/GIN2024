...
class GIN(k.models.Model):
    ...
    def training(self, model, Train_Obs, Train_Obs_Valid, Train_Target, Valid_Obs, Valid_Obs_Valid, Valid_Target,
            ...
            with open(self.result_path + '/testloss.txt', 'w') as tel:
                ...
                for epoch in range(epochs):
                    ...
                    for i in range(len(Ybatch)):
                        ...
                        tf.keras.optimizers.Adam(learning_rate = self.lr, clipnorm=5.0).apply_gradients(zip(gradients, variables))
                        if i %10==0:
                    ...
                    average_test_loss = np.mean(np.array(self.testing(model, test_obs, test_obs_valid, test_targets, batch_size)))
